...
<main class="form-signin">
  <form method="post" action="{{ route('store') }}">
    ...
    <div class="form-floating">
      <input type="name" class="form-control  @error('name') is-invalid @enderror" id="name" placeholder="name@example.com" name="name" required value="{{ old('name') }}" >
    ...
    <div class="form-floating">
      <input type="username" class="form-control  @error('username') is-invalid @enderror" id="username" placeholder="name@example.com" name="username" required value="{{ old('username') }}" >
...
<div class="mt-4">
  <a class="btn btn-success" href="{{ route('login') }}"><i class="bi bi-person-bounding-box"></i>Log in</a>
  or
